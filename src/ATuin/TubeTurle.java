...
public class TubeTurle extends Turtle {
    ...
    public void drawSymbols() {
    	/*Quaternion q = new Quaternion().fromAngleAxis(angle*FastMath.DEG_TO_RAD, new Vector3f(0,0,1));
    	Vector3f debut = new Vector3f(0f, 0f, 0f);
    	Vector3f end = debut.add(0, 50, 0);
    	end = q.mult(end);
    	Line line = new Line(debut, end);
